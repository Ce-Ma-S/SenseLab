...
public interface class ISampleInterfaceConsumer
{
    event Windows::Foundation::TypedEventHandler<SampleInterfaceConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<SampleInterfaceConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<SampleInterfaceConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class SampleInterfaceConsumer sealed  : [Windows::Foundation::Metadata::Default] ISampleInterfaceConsumer
{
public:
    SampleInterfaceConsumer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~SampleInterfaceConsumer();
    ...
    static Windows::Foundation::IAsyncOperation<SampleInterfaceJoinSessionResult^>^ JoinSessionAsync(_In_ Windows::Devices::AllJoyn::AllJoynServiceInfo^ serviceInfo, _Inout_ SampleInterfaceWatcher^ watcher);

    // Call the Frobate method
    Windows::Foundation::IAsyncOperation<SampleInterfaceFrobateResult^>^ FrobateAsync(_In_ int32 interfaceMemberFoo);
    // Call the Bazify method
    Windows::Foundation::IAsyncOperation<SampleInterfaceBazifyResult^>^ BazifyAsync(_In_ SampleInterfaceBar^ interfaceMemberBar);
    // Call the Mogrify method
    Windows::Foundation::IAsyncOperation<SampleInterfaceMogrifyResult^>^ MogrifyAsync(_In_ SampleInterfaceBar^ interfaceMemberBar);

    // Get the value of the Bar property.
    Windows::Foundation::IAsyncOperation<SampleInterfaceGetBarResult^>^ GetBarAsync();

    // Set the value of the Bar property.
    Windows::Foundation::IAsyncOperation<SampleInterfaceSetBarResult^>^ SetBarAsync(_In_ byte value);
    ...
    virtual event Windows::Foundation::TypedEventHandler<SampleInterfaceConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost 
    { 
        Windows::Foundation::EventRegistrationToken add(Windows::Foundation::TypedEventHandler<SampleInterfaceConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ handler) 
        { 
            return _SessionLost += ref new Windows::Foundation::EventHandler<Platform::Object^>
            ([handler](Platform::Object^ sender, Platform::Object^ args)
            {
                handler->Invoke(safe_cast<SampleInterfaceConsumer^>(sender), safe_cast<Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>(args));
    ...
    internal: 
        void raise(SampleInterfaceConsumer^ sender, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^ args) 
        { 
    ...
    virtual event Windows::Foundation::TypedEventHandler<SampleInterfaceConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded 
    { 
        Windows::Foundation::EventRegistrationToken add(Windows::Foundation::TypedEventHandler<SampleInterfaceConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ handler) 
        { 
            return _SessionMemberAdded += ref new Windows::Foundation::EventHandler<Platform::Object^>
            ([handler](Platform::Object^ sender, Platform::Object^ args)
            {
                handler->Invoke(safe_cast<SampleInterfaceConsumer^>(sender), safe_cast<Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>(args));
            }, Platform::CallbackContext::Same);
        } 
        void remove(Windows::Foundation::EventRegistrationToken token) 
        { 
    ...
    internal: 
        void raise(SampleInterfaceConsumer^ sender, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^ args) 
        { 
    ...
    virtual event Windows::Foundation::TypedEventHandler<SampleInterfaceConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved 
    { 
        Windows::Foundation::EventRegistrationToken add(Windows::Foundation::TypedEventHandler<SampleInterfaceConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ handler) 
        { 
            return _SessionMemberRemoved += ref new Windows::Foundation::EventHandler<Platform::Object^>
            ([handler](Platform::Object^ sender, Platform::Object^ args)
            {
                handler->Invoke(safe_cast<SampleInterfaceConsumer^>(sender), safe_cast<Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>(args));
            }, Platform::CallbackContext::Same);
        } 
        void remove(Windows::Foundation::EventRegistrationToken token) 
        { 
    ...
    internal: 
        void raise(SampleInterfaceConsumer^ sender, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^ args) 
        { 
